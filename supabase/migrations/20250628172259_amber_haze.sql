/*
  ...
  1. Insertion des données d'exemple
    - Agents avec leurs informations
    - Biens immobiliers
  ...
  Note: Les profils utilisateurs seront créés via l'inscription normale
  car ils dépendent de la table auth.users gérée par Supabase Auth.
*/
