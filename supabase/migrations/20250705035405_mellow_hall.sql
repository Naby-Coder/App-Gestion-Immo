/*
  ...
  1. Sample Data
    - Insert sample agents with valid UUIDs
    - Insert sample properties with valid UUIDs and proper references
  
  2. Data Integrity
    - All UUIDs are properly formatted
    - Foreign key relationships are maintained
    - Sample data matches the application's expected structure
*/
